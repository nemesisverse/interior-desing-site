...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.overscrollBehaviorY = 'none'; // Targeting html as well
  ...
  return (
    // Added 'z-10' to ensure footer stays structurally on top if needed, 
    // but 'relative' is correct for a standard footer flow.
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-5 mt-8">
            ...
            <a 
              href="https://www.instagram.com/elevatedhomeinterio?igsh=MXFwdWpqZjUxNnFraA%3D%3D&utm_source=qr" 
              target="_blank" 
              rel="noopener noreferrer"
              className="hover:opacity-80 transition-opacity"
            >
